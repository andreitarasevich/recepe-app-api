...
def image_upload_url(recipe_id):
    """Retrurn url for recipe image upload"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test upload images an email to recipe"""
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with spepcific tags"""
        recipe1 = sample_recipe(user=self.user, title='Thai vegetable curry')
        recipe2 = sample_recipe(user=self.user, title='Aubergine with tanini')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Vegearian')
